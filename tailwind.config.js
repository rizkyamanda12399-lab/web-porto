	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'langit-bg': 'url("/portfolio/Langit/bg.png")',
				'myiceland-bg': 'url("/portfolio/MyIceLand/bg.png")',
				'integrafts-bg': 'url("/portfolio/BrandIdentity/bg.png")',
				'kebaya-bg': 'url("/portfolio/Kebaya/bg.png")',
				'personalProject-bg': 'url("/portfolio/PersonalProject/bg.png")',
			},
			animation: {
