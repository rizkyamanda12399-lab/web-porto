    ...
    return (
        <div className="grid xl:gap-[24px] lg:gap-[20px] gap-[16px]">
            ...
            <div className="grid xl:grid-cols-12 lg:grid-cols-12 xl:gap-[32px] lg:gap-[24px] gap-[16px]">
                <div className={`grid items-start xl:col-span-3 lg:col-span-3 col-span-12 xl:p-[40px] lg:p-[30px] p-[20px] ${colorPrimary} xl:rounded-[32px] lg:rounded-[32px] rounded-[20px] order-last`}>
                    <div className="grid xl:gap-[24px] lg:gap-[20px] gap-[16px]">
