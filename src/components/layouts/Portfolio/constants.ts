...
export const PersonalProjectIcon = [
  {
    src: "/icon/figma.svg",
  },
  {
...
export const Coffeehub: PortfolioItem[] = [
  {
    href: "https://coffeehub-ehan.vercel.app/",
    src: "/project/coffeehub.png",
    slides: [
      {
        title: "coffe 1",
        description: "Beautiful landscape of Iceland.",
